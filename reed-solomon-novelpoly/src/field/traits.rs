...
pub trait FieldAdd:
    Clone + Copy + core::fmt::Debug + Default + PartialEq<Self> + Eq + BitXor<Self, Output = Self> + BitXorAssign<Self>
{
...
pub trait FieldMul<Multiplier>: FieldAdd + Mul<Multiplier, Output = Self> + MulAssign<Multiplier>
where
